...
Supplements are useful when food and sun exposure do not cover the gap, but they should be targeted. Vitamin D is the related supplement currently covered in GreenFit: use the [Vitamin D3 supplement page](/supplements/vitamin-d3) for form, dose, timing, toxicity, and testing details.

For calcium or K2, keep the guide-level rule simple: food first, then clinician-guided supplementation when intake, labs, bone density, or risk factors show a gap.
