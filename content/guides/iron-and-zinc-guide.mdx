...
If fatigue is your main symptom, also check [B12 Guide](/guides/b12-guide) and the [Sample B12 page](/supplements/sample-b12), because B12, iron, sleep, calories, thyroid status, and training load can overlap.
...
If you are also trying to raise protein, read [Protein Sources](/guides/protein-guide). The overlap is useful: tofu, dal, chana, oats, and seeds help both goals.
...
If you are building a broad supplement stack, check the [Supplements directory](/supplements) so you do not accidentally double-dose minerals across products.
