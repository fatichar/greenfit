...
export const beautyProducts: ShopProduct[] = [
  {
    ...
    description: "A shower tool for more consistent scalp cleansing without adding another product formula.",
  ...
  },
  {
    ...
    description: "Washable cotton or bamboo rounds can replace disposable cotton pads in a daily routine.",
  ...
  },
  {
    ...
    description: "Worth comparing if you want zinc oxide or titanium dioxide as the sunscreen filter.",
